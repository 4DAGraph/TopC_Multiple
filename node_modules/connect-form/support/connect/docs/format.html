...
<p>The <em>format</em> middleware populates <code>req.format</code> from urls such as <em>/products.json</em> where the <code>req.url</code> becomes <em>/products</em> and <code>req.format</code> becomes <em>json</em>.</p>
