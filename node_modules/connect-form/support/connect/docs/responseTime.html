...
<p>The <em>responseTime</em> middleware responds with the <em>X-Response-Time</em> header indicating the duration of the response in milliseconds. This middleware typically should sit at the top of your stack.</p>
