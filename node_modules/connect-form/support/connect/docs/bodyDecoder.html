...
<h2 id="Body-Decoder">Body Decoder</h2>

<p>The <em>bodyDecoder</em> middleware sniffs the <em>Content-Type</em> header, and decodes the request body appropriately. Supported by default are the <em>application/x-www-form-urlencoded</em>, and <em>application/json</em> content types. To extend simply:</p>

<pre><code class="js"><span class="variable">require</span>(<span class="string">'connect/filters/body-decoder'</span>).<span class="variable">decode</span>[<span class="string">'some-mime/type'</span>] = <span class="keyword">function</span>(<span class="variable">str</span>){
