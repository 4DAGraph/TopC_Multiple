...
<p>The <em>methodOverride</em> middleware checks <code>req.body._method</code> (by default) in order to swap out the http request method.
The <em>bodyDecoder</em> middleware will populate <code>req.body</code> when a form is submitted, which when paired with
this middleware will allow the <em>router</em> middleware to support RESTful forms.</p>

<h3 id="Options">Options</h3>

<pre><code>key   Defaults to _method
</code></pre>

<h3 id="Environment-Variables">Environment Variables</h3>

<pre><code>--methodOverrideKey
</code></pre>
