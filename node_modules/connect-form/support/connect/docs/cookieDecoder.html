...
<h2 id="Cookie-Decoder">Cookie Decoder</h2>

<p>The <em>cookieDecoder</em> middleware parses the <em>Cookie</em> header when present, and populates <code>req.cookies</code>:</p>
