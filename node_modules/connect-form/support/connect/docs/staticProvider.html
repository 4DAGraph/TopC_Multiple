...
<h2 id="Static-Provider">Static Provider</h2>

<p>The <em>staticProvider</em> middleware provides static file serving to the given <em>root</em> directory defaulting to the <strong>CWD</strong>, for example:</p>
